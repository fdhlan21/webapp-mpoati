...
<body>
    <div class="container">
        <div class="login-container">
            <!-- DIV UNTUK LOGO -->
            <div class="logo">
                <img src="assets/img/icon/logo.png" alt="Logo King FC">
            </div>
            <div class="login-card animate__animated animate__fadeInDown">
                <div class="card-body">
                    <h2 style="font-size: 20px; font-weight: bold; text-align: center; color: #3498db;">SI LAPOR MPO ATIK</h2>
                    <p style="text-align: center; color: #3498db;">Sistem Pelaporan Mingguan Posyandu Dasawisma dan Jumantik</p>
